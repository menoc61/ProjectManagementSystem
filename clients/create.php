...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO CLIENT (NomClient, AdresseClient, EmailClient, TelClient) 
            VALUES ('$nomClient', '$adresseClient', '$emailClient', '$telClient')";
    
    if (mysqli_query($conn, $sql)) {
        $success = "Client ajouté avec succès";
    } else {
        $error = "Erreur lors de l'ajout du client: " . mysqli_error($conn);
    }
}
?>
...
<head>
    ...
    <title>Ajouter un Client - Gestion de Projets</title>
                    ...
                    <div class="card-body">
                        <form method="post" action="create.php">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="adresseClient" name="adresseClient" rows="3"></textarea>
                            </div>
                            <div class="mb-3">
