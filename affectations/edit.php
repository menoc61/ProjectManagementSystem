...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Vérifier si cette affectation existe déjà (sauf pour l'affectation en cours)
    $checkSql = "SELECT * FROM AFFECTATION WHERE MatriculePersonnel = '$matriculePersonnel' AND IdTache = $idTache AND IdAffectation != $id";
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $error = "Erreur lors de la modification de l'affectation: " . mysqli_error($conn);
        }
    }
}

$sql = "SELECT * FROM AFFECTATION WHERE IdAffectation = $id";
...
<head>
    ...
    <title>Modifier une Affectation - Gestion de Projets</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Modifier une Affectation</h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <a href="view.php?id=<?php echo $id; ?>" class="btn btn-sm btn-info">
                            <i class="bi bi-eye"></i> Voir l'affectation
                        </a>
                    </div>
                </div>
                ...
                <div class="alert alert-success" role="alert">
                    <?php echo $success; ?>
                    <a href="view.php?id=<?php echo $id; ?>" class="alert-link">Voir l'affectation</a> ou 
                        ...
                        <form method="post" action="edit.php?id=<?php echo $id; ?>">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="matriculePersonnel" name="matriculePersonnel" required>
                                    ...
                                    ?>
                                    <option value="<?php echo $personnel['MatriculePersonnel']; ?>" <?php echo $affectation['MatriculePersonnel'] == $personnel['MatriculePersonnel'] ? 'selected' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="idTache" name="idTache" required>
                                    ...
                                    ?>
                                    <option value="<?php echo $tache['IdTache']; ?>" <?php echo $affectation['IdTache'] == $tache['IdTache'] ? 'selected' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="dateAffectation" name="dateAffectation" value="<?php echo $affectation['DateAffectation']; ?>">
                            </div>
                            
                            <div class="mb-3">
                                <label for="fonctionAffectation" class="form-label">Fonction</label>
                                <input type="text" class="form-control" id="fonctionAffectation" name="fonctionAffectation" value="<?php echo htmlspecialchars($affectation['FonctionAffectation']); ?>">
                            </div>
